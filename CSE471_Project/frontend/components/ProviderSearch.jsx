  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-gray-50 min-h-screen">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight mb-3">Find Expert Service Providers</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">Connect with trusted professionals for all your home and business needs.</p>
      </div>

      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-2">
            <label className="text-sm font-semibold text-gray-700 block">Skill/Profession</label>
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-gray-700 block">Service Category</label>
            <div className="relative">
              <select
                value={serviceType}
              ...
              >
                ...
                <option value="HVAC Technician">❄️ HVAC Technician</option>
          ...
          <div className="space-y-2 flex flex-col justify-end">
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                disabled={loading}
                className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-md transition-all disabled:bg-blue-400 flex items-center justify-center min-w-[120px]"
              >
                {loading ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {results.map((provider) => (
          <div key={provider._id} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group flex flex-col h-full">
            <div className="flex justify-between items-start mb-4">
              <div className="flex gap-4 items-center">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center text-blue-600 font-bold text-xl shadow-sm">
                  {provider.name?.charAt(0) || 'P'}
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors">{provider.name}</h3>
                  <div className="flex items-center gap-1.5 mt-1">
                    ...
                    {provider.isProviderVerified && (
                      <span className="text-green-500" title="Verified Provider">
              ...
              {provider.ratings > 0 && (
                <div className="bg-amber-50 text-amber-600 px-2 py-1 rounded-lg flex items-center gap-1">
                  ...
                  <span className="font-bold text-sm">{provider.ratings.toFixed(1)}</span>
                </div>
              )}
            </div>
            ...
            <div style={{display:'flex', flexDirection:'column', gap:'12px', marginBottom:'24px', flex:1}}>
              <div style={{display:'flex', alignItems:'flex-start', gap:'12px', color:'#4b5563', fontSize:'14px'}}>
                ...
                <div>
                  ...
                  <span style={{color:'#6b7280'}}>{provider.skills?.join(', ') || 'Not specified'}</span>
                </div>
              </div>
              ...
              <div style={{display:'flex', alignItems:'flex-start', gap:'12px', color:'#4b5563', fontSize:'14px'}}>
                <svg width="20" height="20" style={{flexShrink:0, color:'#9ca3af', marginTop:'2px'}} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                <div>
                  <span style={{display:'block', fontWeight:600, color:'#1f2937'}}>Location</span>
              ...
              <div style={{display:'flex', alignItems:'flex-start', gap:'12px', color:'#4b5563', fontSize:'14px'}}>
                ...
                <div>
                  ...
                  <span style={{color:'#6b7280'}}>{provider.workType === 'mobile' ? 'Mobile' : provider.workType === 'shop' ? 'Fixed Location' : 'Both'}</span>
                </div>
              </div>
            </div>
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'12px', marginTop:'auto'}}>
              <button 
                onClick={() => provider.phone ? window.location.href = `tel:${provider.phone}` : alert('Phone number not available')}
              ...
              <button 
                onClick={() => window.location.href = `/chat?provider=${provider._id}`}
                style={{gridColumn:'span 1', padding:'10px', background:'#eef2ff', border:'1px solid #e0e7ff', borderRadius:'12px', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:'6px', fontSize:'14px', fontWeight:500, color:'#4338ca'}}
              >
              ...
              <button 
                ...
                style={{gridColumn:'span 2', padding:'12px', marginTop:'4px', background:'#2563eb', border:'none', borderRadius:'12px', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:'8px', fontSize:'14px', fontWeight:600, color:'white'}}
              >
            ...
            <div className="p-6 space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none" 
                  />
                </div>
                <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <textarea 
                  ...
                  rows="4"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none resize-none" 
                />
              </div>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button 
                  ...
                  className="flex-1 py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-2"
                >
                  Confirm Booking
                </button>
              </div>
